...
impl LayoutCalculator {
    ...
    pub fn new() -> Self {
        Self {
            ...
            current_dimensions: (dynamic_ui::MIN_TERMINAL_WIDTH, dynamic_ui::MIN_TERMINAL_HEIGHT),
        }
    }
    ...
    pub fn get_optimal_games_per_page(&self, available_height: u16, detail_level: DetailLevel) -> usize {
        let height_per_game = match detail_level {
            ...
            DetailLevel::Extended => dynamic_ui::BASE_GAME_HEIGHT + dynamic_ui::EXTENDED_GAME_HEIGHT_BONUS,
        };
    ...
    pub fn calculate_content_positioning(&self, layout_config: &LayoutConfig) -> ContentPositioning {
...
mod tests {
    ...
    fn test_detail_level_determination() {
        ...
        assert_eq!(calculator.determine_detail_level(100), DetailLevel::Standard);
        assert_eq!(calculator.determine_detail_level(119), DetailLevel::Standard);
        
        // Test extended detail level
        assert_eq!(calculator.determine_detail_level(120), DetailLevel::Extended);
        assert_eq!(calculator.determine_detail_level(200), DetailLevel::Extended);
    }
    ...
    fn test_detail_level_boundary_conditions() {
        ...
        assert_eq!(calculator.determine_detail_level(u16::MAX), DetailLevel::Extended);
    }
    ...
    fn test_games_per_page_edge_cases() {
        ...
        assert_eq!(calculator.get_optimal_games_per_page(1, DetailLevel::Minimal), 1);
        assert_eq!(calculator.get_optimal_games_per_page(2, DetailLevel::Standard), 1);
        assert_eq!(calculator.get_optimal_games_per_page(4, DetailLevel::Extended), 1);
        
        // Test with zero height (edge case)
        assert_eq!(calculator.get_optimal_games_per_page(0, DetailLevel::Minimal), 1);
        ...
        let large_height_extended = calculator.get_optimal_games_per_page(100, DetailLevel::Extended);
