...
pub use teletext_ui::{GameResultData, TeletextPage, TeletextPageConfig};
pub use ui::components::abbreviations::get_team_abbreviation;
pub use ui::teletext::CompactDisplayConfig;
